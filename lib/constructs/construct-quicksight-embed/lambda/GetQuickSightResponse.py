...
def handler(event, context, mode):
    ...
    webIdentitySubject = webIdentityProvider = authEvalMode = region = expiryTs = urlType = openIdToken = None
    ...
    def checkTokenValidity():
        ...
        try:
            ...
            #---Replace 8 = padding with precise number
            # payload = json.loads(base64.b64decode(openIdToken.split('.')[1]+ "========"))
            base64Payload = openIdToken.split('.')[1]
            ...
            if authEvalMode == 'STS':
                ...
                #---Replace 8 = padding with precise number
                # header = json.loads(base64.b64decode(openIdToken.split('.')[0]+ "========"))
                base64Header = openIdToken.split('.')[0]
                ...
                if cognitoUrl == webIdentityProvider and expiryTs > time.time():
                    ...
                    for key in keys:
                        if key['kid'] == header['kid'] :
                            ...
                            if public_key.verify( base64HeaderAndPayload.encode('utf-8'), base64url_decode(base64Signature.encode('utf-8')) ): 
                                return True
