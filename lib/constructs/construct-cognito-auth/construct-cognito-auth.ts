...
export class CognitoAuth extends Construct {
  ...
  constructor(scope: Construct, id: string, props: CognitoProps) {
    ...
    const userPool = new UserPool(this, "UserPool", {
      ...
      // Invite Message
      userInvitation: {
        emailSubject: `Welcome to ${this.node.tryGetContext("projectName")}`,
        emailBody: `Hello {username}, you have been invited to join ${this.node.tryGetContext(
          "projectName"
        )}! Your temporary password is {####}`,
        smsMessage: `Hello {username}, your temporary password for ${this.node.tryGetContext(
          "projectName"
        )} is {####}`,
      },
      // Verification Message
      userVerification: {
        emailSubject: `Verify your email for ${this.node.tryGetContext(
          "projectName"
        )}`,
        emailBody: `Thanks for signing up for ${this.node.tryGetContext(
          "projectName"
        )}! Your verification code is {####}`,
        emailStyle: VerificationEmailStyle.CODE,
        smsMessage: `Thanks for signing up for ${this.node.tryGetContext(
          "projectName"
        )}! Your verification code is {####}`,
      },
    ...
    this.AdminUserRoleManagedPolicy = new ManagedPolicy(
      this,
      "AdminUserRoleManagedPolicy",
      {
    ...
    this.StandardUserRoleManagedPolicy = new ManagedPolicy(
      this,
      "StandardUserRoleManagedPolicy",
      {
    ...
    const adminUser = new CfnUserPoolUser(this, "DefaultAdminUser", {
      ...
      userAttributes: [
        ...
        {
          name: "given_name",
          value: this.node.tryGetContext("projectName"),
        },
        {
          name: "family_name",
          value: "Admin",
    ...
    const cfnUserPoolUserToGroupAttachment =
